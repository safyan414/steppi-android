 ...
 * Combination of com.huawei.hms.common.data.AbstractDataBuffer and com.google.android.gms.common.data.AbstractDataBuffer.<br/>
 * com.huawei.hms.common.data.AbstractDataBuffer: <br/>
 * com.google.android.gms.common.data.AbstractDataBuffer: Default implementation of DataBuffer. An AbstractDataBuffer wraps data provided across the binder from Google Play services.<br/>
 */
public abstract class AbstractDataBuffer<XT> extends org.xms.g.utils.XObject implements org.xms.g.common.data.DataBuffer<XT> {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.close()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.get(int)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.getCount()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.isClosed()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.iterator()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.release()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.AbstractDataBuffer.singleRefIterator()
