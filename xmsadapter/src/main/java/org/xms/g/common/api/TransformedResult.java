 ...
 * Combination of com.huawei.hms.support.api.client.ConvertedResult and com.google.android.gms.common.api.TransformedResult.<br/>
 * com.huawei.hms.support.api.client.ConvertedResult: <br/>
 * com.google.android.gms.common.api.TransformedResult: Represents a pending result that has been transformed by one or more subsequent API calls.<br/>
 */
public abstract class TransformedResult<XR extends org.xms.g.common.api.Result> extends org.xms.g.utils.XObject {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.ConvertedResult.finalExec(com.huawei.hms.support.api.client.ResultCallbacks<? super R>)
