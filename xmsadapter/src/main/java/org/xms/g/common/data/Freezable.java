 ...
 * Combination of com.huawei.hms.common.data.Freezable and com.google.android.gms.common.data.Freezable.<br/>
 * com.huawei.hms.common.data.Freezable: <br/>
 * com.google.android.gms.common.data.Freezable: Interface for data objects that support being frozen into immutable representations.<br/>
 */
public interface Freezable<XT> extends org.xms.g.utils.XInterface {
     ...
     * com.huawei.hms.common.data.Freezable.freeze()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.data.Freezable.isDataValid()
