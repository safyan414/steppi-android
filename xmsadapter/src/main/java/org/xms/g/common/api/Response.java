 ...
 * Combination of com.huawei.hms.common.api.Response and com.google.android.gms.common.api.Response.<br/>
 * com.huawei.hms.common.api.Response: <br/>
 * com.google.android.gms.common.api.Response: Represents the successful result of invoking an API method in Google Play services using a subclass of GoogleApi. Wraps a instance of a Result.<br/>
 */
public class Response<XT extends org.xms.g.common.api.Result> extends org.xms.g.utils.XObject {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.api.Response.Response(T)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.api.Response.setResult(T)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.api.Response.getResult()
