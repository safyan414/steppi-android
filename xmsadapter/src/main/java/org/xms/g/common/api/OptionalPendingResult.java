 ...
 * Combination of com.huawei.hms.common.api.OptionalPendingResult and com.google.android.gms.common.api.OptionalPendingResult.<br/>
 * com.huawei.hms.common.api.OptionalPendingResult: <br/>
 * com.google.android.gms.common.api.OptionalPendingResult: OptionalPendingResults are PendingResults with additional support for non-blocking accessors.<br/>
 */
public abstract class OptionalPendingResult<XR extends org.xms.g.common.api.Result> extends org.xms.g.common.api.PendingResult<XR> {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.api.OptionalPendingResult.get()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.common.api.OptionalPendingResult.isDone()
    ...
    public static class XImpl<XR extends org.xms.g.common.api.Result> extends org.xms.g.common.api.OptionalPendingResult<XR> {
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.await()
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.await(long,java.util.concurrent.TimeUnit)
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.cancel()
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.isCanceled()
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.setResultCallback(com.huawei.hms.support.api.client.ResultCallback<? super R>)
         ...
         * Support running environments including both HMS and GMS which are chosen by users.<br/>
         * Below are the references of HMS apis and GMS apis respectively:<br/>
         * com.huawei.hms.common.api.OptionalPendingResult.setResultCallback(com.huawei.hms.support.api.client.ResultCallback<? super R>,long,java.util.concurrent.TimeUnit)
