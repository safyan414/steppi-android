 ...
 * Combination of com.huawei.hms.support.api.client.PendingResult and com.google.android.gms.common.api.PendingResult.<br/>
 * com.huawei.hms.support.api.client.PendingResult: <br/>
 * com.google.android.gms.common.api.PendingResult: Represents a pending result from calling an API method in Google Play services.<br/>
 */
public abstract class PendingResult<XR extends org.xms.g.common.api.Result> extends org.xms.g.utils.XObject {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.await()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.await(long,java.util.concurrent.TimeUnit)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.cancel()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.isCanceled()
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.setResultCallback(com.huawei.hms.support.api.client.ResultCallback<? super R>)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.support.api.client.PendingResult.setResultCallback(com.huawei.hms.support.api.client.ResultCallback<? super R>,long,java.util.concurrent.TimeUnit)
