...
public class TaskCompletionSource<XTResult> extends org.xms.g.utils.XObject {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hmf.tasks.TaskCompletionSource.setException(java.lang.Exception)
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hmf.tasks.TaskCompletionSource.setResult(TResult): <a href="https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section10478151064312">https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section10478151064312</a><br/>
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hmf.tasks.TaskCompletionSource.trySetException(java.lang.Exception): <a href="https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section15858152685514">https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section15858152685514</a><br/>
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hmf.tasks.TaskCompletionSource.trySetResult(TResult): <a href="https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section34413247551">https://developer.huawei.com/consumer/en/doc/HMSCore-References-V5/taskcompletionsource-0000001050123103-V5#EN-US_TOPIC_0000001050123103__section34413247551</a><br/>
