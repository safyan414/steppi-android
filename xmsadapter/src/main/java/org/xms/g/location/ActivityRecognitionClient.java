...
public class ActivityRecognitionClient extends org.xms.g.common.api.ExtensionApi<org.xms.g.common.api.Api.ApiOptions.NoOptions> {
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.location.ActivityIdentificationService.ActivityIdentificationService(android.app.Activity): <a href="https://developer.huawei.com/consumer/en/doc/activityidentificationservice">https://developer.huawei.com/consumer/en/doc/activityidentificationservice</a><br/>
     * com.google.android.gms.location.ActivityRecognitionClient.ActivityRecognitionClient(android.app.Activity): <a href="https://developers.google.com/android/reference/com/google/android/gms/location/ActivityRecognitionClient">https://developers.google.com/android/reference/com/google/android/gms/location/ActivityRecognitionClient</a><br/>
     *
     ...
     * Support running environments including both HMS and GMS which are chosen by users.<br/>
     * Below are the references of HMS apis and GMS apis respectively:<br/>
     * com.huawei.hms.location.ActivityIdentificationService.ActivityIdentificationService(android.content.Context): <a href="https://developer.huawei.com/consumer/en/doc/activityidentificationservice">https://developer.huawei.com/consumer/en/doc/activityidentificationservice</a><br/>
     * com.google.android.gms.location.ActivityRecognitionClient.ActivityRecognitionClient(android.content.Context): <a href="https://developers.google.com/android/reference/com/google/android/gms/location/ActivityRecognitionClient">https://developers.google.com/android/reference/com/google/android/gms/location/ActivityRecognitionClient</a><br/>
     *
