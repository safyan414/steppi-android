...
// [Modified By HMSConvertor] class STNotifyFireBaseMessagingService : FirebaseMessagingService() {
class STNotifyHMSMessagingService : HmsMessageService() {
    companion object {
    ...
    override fun onNewToken(refreshedToken: String) {
        ...
        Log.d("HMSMessaging", "new token: $refreshedToken")
